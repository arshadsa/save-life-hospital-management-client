...
export const Footer = () => {
    ...
    return (
        <footer className='bg-white'>
            ...
            <a href="#home" className='bg-sky-700 w-10 h-10 inline-block rounded-md fixed bottom-[40%] right-[3%] bounce2'> <BsFillArrowUpCircleFill className='text-white translate-y-3 translate-x-3' /></a>
