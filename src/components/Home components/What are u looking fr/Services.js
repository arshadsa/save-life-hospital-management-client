...
{/* Find pharmacy card button */}
         ...
         <div  className="featured2 bg-[#02213dde] h-auto lg:max-x-lg md:max-w-md sm:max-w-sm  ">         
          <div className="flex justify-center"> 
...
{/* Find lab card button Stastci  */}
         ...
         <div  className="featured3 bg-[#1b82e2] h-auto lg:max-x-lg md:max-w-md sm:max-w-sm  ">         
         <div className="flex justify-center"> 
