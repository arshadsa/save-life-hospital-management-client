...
<div className='mr-10'>
    ...
    <div className='mb-5'>
        <h2 className='text-xl mb-2 text-primary font-bold'>Common health issue</h2>
    ...
    <div className='mb-5'>
        <h2 className='text-xl mb-2 text-primary font-bold'>Specialist advice</h2>
    ...
    <div>
        <h2 className='text-2xl mb-2 text-primary font-bold'>Mental health and wellbeing</h2>
