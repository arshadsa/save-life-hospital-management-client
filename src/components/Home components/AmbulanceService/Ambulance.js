...
const Ambulance = () => {
  return (
    <div className='Container pb-12 mx-auto p-6 max-w-lg sm:px-6 md:max-w-2xl md:px-8 lg:max-w-5xl xl:max-w-7xl 2xl:container'>
      <div>
      ...
      <div className='grid gap-9 sm:grid-cols-1 lg:grid-cols-3 2xl:grid-cols-3'>
        ...
        <div className='bg-white drop-shadow-xl ring-4 ring-gray-50 ring-offset-2'>
          {/* Image Content  */}
          <div >
            <img className='w-[100%]' src={Ambulance1} alt="" />
          </div>
          {/* Text Content  */}
        <div className='mb-7 pl-3'>
          <h3 className='text-xl tmb-2 mt-5 mb-5 font-bold text-[#1b82e2]'>Ambulance Car</h3>
          ...
          <a className='flex gap-2 cursor-pointer text-[#1b82e2]'>READ MORE
        ...
        <div className='bg-white drop-shadow-xl ring-4 ring-gray-50 ring-offset-2'>
          {/* Image Content  */}
          <div>
            <img className='w-[100%]' src={Ambulance2} alt="" />
          </div>
          {/* Text Content  */}
        <div className='mb-7 pl-3'>
          <h3 className='text-xl tmb-2 mt-5 mb-5 font-bold text-[#1b82e2]'>Medical Flight Services</h3>
        ...
        <div className='bg-white drop-shadow-xl ring-4 ring-gray-50 ring-offset-2'>
          {/* Image Content  */}
          <div>
            <img className='w-[100%]' src={Ambulance3} alt="" />
          </div>
          {/* Text Content  */}
        <div className='mb-7 pl-3'>
          <h3 className='text-xl tmb-2 mt-5 mb-5 font-bold text-[#1b82e2]'>Medical Escort</h3>
          <p className='text-semibold pr-10 mb-5'>Aenean a mi mi. Sed sem eros, commodo ut lacinia ut, eleifend id ipsum.</p>
          <div className='text-primary'>
          <p className='flex gap-2 cursor-pointer text-[#1b82e2]'>READ MORE
            <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" /></svg></span>
         </p>
          </div>
